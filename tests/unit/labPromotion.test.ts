...
describe("breakout RSI filter", () => {
  ...
  it("uses the Lab's stop and target in ATRs: hourly ones for a coin, 5-minute ones for a US stock", () => {
    ...
    const stock = labTunedPersona(model)!.evaluate({ ...ctx(55), symbol: "AAPL.US" })!;
